...
namespace TransferManagerCE
{
    internal class SelectionTool : DefaultTool
    {
        ...
        public void Enable()
        {
            ...
            {
                TransferBuildingPanel.Instance.ShowPanel(WorldInfoPanel.GetCurrentInstanceID().Building);
            }
        }
        ...
        protected override void OnDisable() {
            ...
            TransferBuildingPanel.Instance?.HidePanel();
        }
        ...
        private void SelectBuilding(ushort buildingId)
        {
            ...
            // Open building panel
            TransferBuildingPanel.Instance?.ShowPanel(buildingId);
        }
