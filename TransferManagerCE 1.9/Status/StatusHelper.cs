...
namespace TransferManagerCE
{
    public class StatusHelper
    {
                ...
                if (vehicle.m_flags != 0 && vehicle.Info != null)
                {
                    ...
                    switch (vehicle.Info.m_vehicleAI)
                    {
                        case HearseAI:
                            {
                                // Hearse
                                m_listStatus.Add(new StatusDataDead(eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                        ...
                        case AmbulanceAI:
                            {
                                m_listStatus.Add(new StatusDataSick(eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                        ...
                        case GarbageTruckAI:
                            {
                                m_listStatus.Add(new StatusDataGarbage(eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                        ...
                        case FireTruckAI:
                            {
                                m_listStatus.Add(new StatusDataFire(eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                        ...
                        case PoliceCarAI:
                            {
                                m_listStatus.Add(new StatusDataCrime(eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                        ...
                        case PostVanAI:
                            {
                                m_listStatus.Add(new StatusDataMail((TransferReason)vehicle.m_transferType, eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                        ...
                        case ParkMaintenanceVehicleAI:
                            {
                                m_listStatus.Add(new StatusParkMaintenance(eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                        ...
                        case CargoTruckAI:
                            {
                                switch (eBuildingType)
                                {
                                    case BuildingTypeHelper.BuildingType.Commercial:
                                        {
                                            m_listStatus.Add(new StatusDataCommercial(eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                    ...
                                    case BuildingTypeHelper.BuildingType.Warehouse:
                                        {
                                            ...
                                            if (warehouseAI != null)
                                            {
                                                ...
                                                m_listStatus.Add(new StatusDataWarehouse(actualTransferReason, eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                    ...
                                    case BuildingTypeHelper.BuildingType.GenericExtractor:
                                        {
                                            m_listStatus.Add(new StatusIndustrialExtractor((TransferReason)vehicle.m_transferType, eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                            m_listAddedReasons.Add((TransferReason)vehicle.m_transferType);
                                            m_listAddedVehicles.Add(actualVehicleId);
                                            break;
                                        }
                                    case BuildingTypeHelper.BuildingType.GenericProcessing:
                                        {
                                            m_listStatus.Add(new StatusIndustrialProcessing((TransferReason)vehicle.m_transferType, eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                            m_listAddedReasons.Add((TransferReason)vehicle.m_transferType);
                                            m_listAddedVehicles.Add(actualVehicleId);
                                            break;
                                        }
                                    case BuildingTypeHelper.BuildingType.ExtractionFacility:
                                        {
                                            m_listStatus.Add(new StatusDataExtractionFacility((TransferReason)vehicle.m_transferType, eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                            m_listAddedReasons.Add((TransferReason)vehicle.m_transferType);
                                            m_listAddedVehicles.Add(actualVehicleId);
                                            break;
                                        }
                                    case BuildingTypeHelper.BuildingType.DisasterShelter:
                                        {
                                            ...
                                            m_listStatus.Add(new StatusDataShelter(TransferReason.Food, eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                    ...
                                    case BuildingTypeHelper.BuildingType.PowerPlant:
                                        {
                                            // Add a generic vehicle
                                            m_listStatus.Add(new StatusPowerPlant((TransferReason)vehicle.m_transferType, eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                            m_listAddedReasons.Add((TransferReason)vehicle.m_transferType);
                                            m_listAddedVehicles.Add(actualVehicleId);
                                            break;
                                        }
                                    case BuildingTypeHelper.BuildingType.FishMarket:
                                        {
                                            // Add a generic vehicle
                                            m_listStatus.Add(new StatusDataMarket((TransferReason)vehicle.m_transferType, eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                            m_listAddedReasons.Add((TransferReason)vehicle.m_transferType);
                                            m_listAddedVehicles.Add(actualVehicleId);
                                            break;
                                        }
                                    default:
                                        {
                                            ...
                                            {
                                                // Add a generic vehicle
                                                m_listStatus.Add(new StatusDataGeneric((TransferReason)vehicle.m_transferType, eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                                m_listAddedVehicles.Add(actualVehicleId);
                                            }
                                            break;
                                        }
        ...
        {  
            ...
            {
                m_listStatus.Add(new StatusDataDead(eBuildingType, buildingId, 0, 0));
                m_listAddedReasons.Add(TransferReason.Dead);
            }
            if (!m_listAddedReasons.Contains(TransferReason.Sick))
            {
                m_listStatus.Add(new StatusDataSick(eBuildingType, buildingId, 0, 0));
                m_listAddedReasons.Add(TransferReason.Sick);
            }
            if (!m_listAddedReasons.Contains(TransferReason.Garbage))
            {
                m_listStatus.Add(new StatusDataGarbage(eBuildingType, buildingId, 0, 0));
                m_listAddedReasons.Add(TransferReason.Garbage);
            }
            if (!m_listAddedReasons.Contains(TransferReason.Fire))
            {
                m_listStatus.Add(new StatusDataFire(eBuildingType, buildingId, 0, 0));
                m_listAddedReasons.Add(TransferReason.Fire);
            }
            if (!m_listAddedReasons.Contains(TransferReason.Crime))
            {
                m_listStatus.Add(new StatusDataCrime(eBuildingType, buildingId, 0, 0));
                m_listAddedReasons.Add(TransferReason.Crime);
            }
            ...
            {
                m_listStatus.Add(new StatusDataMail(TransferReason.Mail, eBuildingType, buildingId, 0, 0));
                ...
                case BuildingTypeHelper.BuildingType.Warehouse:
                    {
                        ...
                        if (warehouseAI != null)
                        {
                            ...
                            {
                                m_listStatus.Add(new StatusDataWarehouse(actualTransferReason, eBuildingType, buildingId, 0, 0));
                            }
                        }
                        break;
                    }
                ...
                case BuildingTypeHelper.BuildingType.UniqueFactory:
                    {
                        ...
                        if (buildingAI != null)
                        {
                            ...
                            {
                                m_listStatus.Add(new StatusDataProcessingFacility(buildingAI.m_inputResource1, eBuildingType, buildingId, 0, 0));
                            }
                            if (buildingAI.m_inputResource2 != TransferReason.None && !m_listAddedReasons.Contains(buildingAI.m_inputResource2))
                            {
                                m_listStatus.Add(new StatusDataProcessingFacility(buildingAI.m_inputResource2, eBuildingType, buildingId, 0, 0));
                            }
                            if (buildingAI.m_inputResource3 != TransferReason.None && !m_listAddedReasons.Contains(buildingAI.m_inputResource3))
                            {
                                m_listStatus.Add(new StatusDataProcessingFacility(buildingAI.m_inputResource3, eBuildingType, buildingId, 0, 0));
                            }
                            if (buildingAI.m_inputResource4 != TransferReason.None && !m_listAddedReasons.Contains(buildingAI.m_inputResource4))
                            {
                                m_listStatus.Add(new StatusDataProcessingFacility(buildingAI.m_inputResource4, eBuildingType, buildingId, 0, 0));
                            }
                            m_listStatus.Add(new StatusDataProcessingFacility(buildingAI.m_outputResource, eBuildingType, buildingId, 0, 0));
                        }
                        break;
                    }
                case BuildingTypeHelper.BuildingType.Commercial:
                    {
                        ...
                        {
                            m_listStatus.Add(new StatusDataCommercial(eBuildingType, buildingId, 0, 0));
                        }
                        break;
                    }
                case BuildingTypeHelper.BuildingType.DisasterShelter:
                    {
                        ...
                        if (!bContainsFood)
                        {
                            m_listStatus.Add(new StatusDataShelter(TransferReason.Food, eBuildingType, buildingId, 0, 0));
                        }
                        break;
                    }
                case BuildingTypeHelper.BuildingType.GenericExtractor:
                    {
                        ...
                        {
                            m_listStatus.Add(new StatusIndustrialExtractor(material, eBuildingType, buildingId, 0, 0));
                        }
                        break;
                    }
                case BuildingTypeHelper.BuildingType.GenericProcessing:
                    {
                        ...
                        if (material != TransferReason.None && !m_listAddedReasons.Contains(material))
                        {
                            m_listStatus.Add(new StatusIndustrialProcessing(material, eBuildingType, buildingId, 0, 0));
                        }
                        ...
                        {
                            m_listStatus.Add(new StatusIndustrialProcessing(material2, eBuildingType, buildingId, 0, 0));
                        }
                        ...
                        {
                            m_listStatus.Add(new StatusIndustrialProcessing(outMaterial, eBuildingType, buildingId, 0, 0));
                        }
                        break;
                    }
                ...
                case BuildingTypeHelper.BuildingType.Park:
                    {
                        ...
                        {
                            m_listStatus.Add(new StatusParkMaintenance(eBuildingType, buildingId, 0, 0));
                        }
                        break;
                    }
                case BuildingTypeHelper.BuildingType.ExtractionFacility:
                    {
                        ...
                        {
                            m_listStatus.Add(new StatusDataExtractionFacility(material, eBuildingType, buildingId, 0, 0));
                        }
                        break;
                    }
                case BuildingTypeHelper.BuildingType.PowerPlant:
                    {
                        ...
                        if (material != TransferReason.None && !m_listAddedReasons.Contains(material))
                        {
                            m_listStatus.Add(new StatusPowerPlant(material, eBuildingType, buildingId, 0, 0));
                        }
                        break;
                    }
                ...
                case BuildingTypeHelper.BuildingType.PostSortingFacility:
                    {
                        ...
                        {
                            m_listStatus.Add(new StatusDataMail(TransferReason.UnsortedMail, eBuildingType, buildingId, 0, 0));
                        }
                        if (!m_listAddedReasons.Contains(TransferReason.SortedMail) && !m_listAddedReasons.Contains(TransferReason.IncomingMail))
                        {
                            m_listStatus.Add(new StatusDataMail(TransferReason.SortedMail, eBuildingType, buildingId, 0, 0));
                        }
                        break;
                    }
                case BuildingTypeHelper.BuildingType.FishMarket:
                    {
                        ...
                        {
                            m_listStatus.Add(new StatusDataMarket(TransferReason.Fish, eBuildingType, buildingId, 0, 0));
                        }
                        break;
                    }
            }
