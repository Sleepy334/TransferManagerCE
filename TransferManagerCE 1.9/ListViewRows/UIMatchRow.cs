    ...
    public class UIMatchRow : UIPanel, IUIFastListRow
    {
        ...
        public override void Start()
        {
            ...
            if (m_lblPriority != null)
            {
                ...
                m_lblPriority.width = BuildingPanel.iCOLUMN_WIDTH_SMALL;
        ...
        {
            MatchData? rowData = (MatchData?)data;
            if (rowData != null)
            {
                m_data = rowData;
                if (m_lblTime != null)
                {
                    m_lblTime.text = rowData.m_TimeStamp.ToString("h:mm:ss");
                }
                if (m_lblMaterial != null)
                {
