...
namespace TransferManagerCE
{
    public static class DependencyUtilities
    {
        ...
        private static bool s_bHasAdvancedOutsideConnectionsBeenCheckedRunning = false;
        private static bool s_bIsAdvancedOutsideConnectionsRunning = false;
        ...
        public static bool IsPloppableRICORunning()
        {
            ...
            if (TransferManagerLoader.IsLoaded())
            {
                ...
                {
                    s_bIsPloppableRicoRunning = IsPluginRunning(sMOD_ID, sAssemblyName);
        ...
        public static bool IsAdvancedOutsideConnectionsRunning()
        {
            ...
            if (TransferManagerLoader.IsLoaded())
            {
                if (!s_bHasAdvancedOutsideConnectionsBeenCheckedRunning)
                {
                    s_bIsAdvancedOutsideConnectionsRunning = IsPluginRunning(sMOD_ID, "AdvancedOutsideConnection");
                    s_bHasAdvancedOutsideConnectionsBeenCheckedRunning = true;
                }

                return s_bIsAdvancedOutsideConnectionsRunning;
            }
            else
            {
