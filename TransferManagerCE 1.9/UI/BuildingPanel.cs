...
namespace TransferManagerCE
{
    public class BuildingPanel : UIPanel
    {
        ...
        public const int iLISTVIEW_MATCHES_HEIGHT = 242;
        ...
        public override void Start()
        {
            ...
            if (tabPathing != null)
            {
                ...
                m_btnReset = UIUtils.AddButton(tabPathing, Localization.Get("btnResetPathingStatistics"), 200, iButtonHeight);
                if (m_btnReset != null)
                {
        ...
        public void UpdatePanel()
        {
            if (m_buildingId != 0)
            {
                if (m_tabStrip != null)
                {
                    ...
                    // Update pathing tab count, do not hide pathing tab once it is shown for this building.
