...
namespace TransferManagerCE.CustomManager
{
    public class CustomTransferOffer
    {
        ...
        private HashSet<DistrictData>? m_actualDistricts;
        private HashSet<DistrictData>? m_allowedDistrictsIncoming;
        private HashSet<DistrictData>? m_allowedDistrictsOutgoing;
