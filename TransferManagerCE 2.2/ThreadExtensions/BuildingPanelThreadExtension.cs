...
{
    public class BuildingPanelThreadExtension : ThreadingExtensionBase
    {
        ...
        public static void HandleOffer(TransferOffer offer)
        {
            if (BuildingPanel.Instance != null && 
                ...
                InstanceHelper.GetBuildings(offer.m_object).Contains(BuildingPanel.Instance.GetBuildingId()))
            {
                InvalidatePanel();
            }
        }
