        ...
        public void Setup(UITabStrip tabStrip)
        {
            ...
            if (tabSettings != null)
            {
                ...
                if (m_buildingRestrictionGroup != null)
                {
                    ...
                    // Buttons
                    m_btnBuildingRestrictionsIncoming = UIUtils.AddButton(m_pnlBuildingRestrictionsIncoming, Localization.Get("btnBuildingRestrictions"), 280, iButtonHeight, OnBuildingRestrictionsIncomingClicked);
                    ...
                    // Buttons
                    m_btnBuildingRestrictionsOutgoing = UIUtils.AddButton(m_pnlBuildingRestrictionsOutgoing, Localization.Get("btnBuildingRestrictions"), 280, iButtonHeight, OnBuildingRestrictionsOutgoingClicked);
