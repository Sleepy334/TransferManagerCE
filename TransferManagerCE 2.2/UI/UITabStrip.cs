...
namespace TransferManagerCE
{
    public class UITabStrip : UIPanel
    {
        ...
        public UIPanel? AddTabIcon(string sIcon, string sText, UITextureAtlas atlas, string sTooltip)
        {
            if (m_tabs != null && m_tabButtonPanel != null)
            {
                ...
                buttonPanel.name = "TransferManagerCE.TabButtonPanel";
        ...
        public UIPanel? AddTabIcon(string sIcon, string sText, string sTooltip)
        {
            if (m_tabs != null && m_tabButtonPanel != null)
            {
                return AddTabIcon(sIcon, sText, m_tabButtonPanel.atlas, sTooltip);
            }
            return null;
        }
            ...
            if (m_tabs != null && iIndex < m_tabs.Count)
            {
                ...
                if (button != null)
                {
                    ...
                    if (button.components.Count > 0)
                    {
                        ...
                        if (subPanel != null && subPanel.components.Count >= 2)
                        {
