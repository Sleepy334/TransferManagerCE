...
namespace TransferManagerCE
{
    public class BuildingPanel : UIPanel
    {
        ...
        public override void Start()
        {
            ...
            // Status tab
            UIPanel? tabStatus = m_tabStrip.AddTab(Localization.Get("tabBuildingPanelStatus"), 150f);
            if (tabStatus != null)
            {
            ...
            if (tabTransfers != null)
            {
                ...
                if (m_listOffers != null)
                {
                    ...
                    m_listOffers.AddColumn(ListViewRowComparer.Columns.COLUMN_DESCRIPTION, Localization.Get("listBuildingPanelOffersColumn6"), "Offer description", iCOLUMN_WIDTH_300, BuildingPanel.iHEADER_HEIGHT, UIHorizontalAlignment.Left, UIAlignAnchor.TopRight, null);
