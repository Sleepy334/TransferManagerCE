...
namespace TransferManagerCE.TransferOffers
{
    ...
    {
        public const int iREREQUEST_TIMER_LEVEL1 = 32; // Start re-requesting 
        public const int iREREQUEST_TIMER_LEVEL2 = 64; // Level 2 - Vehicles need to be closer in to count
