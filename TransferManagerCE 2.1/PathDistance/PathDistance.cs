...
namespace TransferManagerCE
{
    public class PathDistance
    {
        ...
        public uint FindNearestNeighbor(bool bstartActive, ushort startNodeId, HashSet<ushort>? candidates)
        {
        ...
        {
            return IsNetInfoValid(info, m_laneTypes, m_service1, m_service2, m_service3);
        }

        public static bool IsNetInfoValid(NetInfo info, NetInfo.LaneType laneTypes, ItemClass.Service service1, ItemClass.Service service2, ItemClass.Service service3)
        {
