    ...
    public class StatsPanel : UIPanel
    {
        ...
        public override void Start()
        {
            ...
            if (tabGeneral != null)
            {
                ...
                if (m_generalStats != null)
                {
                    ...
                    m_generalStats.AddColumn(ListViewRowComparer.Columns.COLUMN_VALUE, "Value", "", iCOLUMN_LARGE_WIDTH, iHEADER_HEIGHT, UIHorizontalAlignment.Left, UIAlignAnchor.TopRight, null);
                }
            }
            ...
            if (tabGame != null)
            {
                ...
                if (m_gameStats != null)
                {
                    ...
                    m_gameStats.AddColumn(ListViewRowComparer.Columns.COLUMN_VALUE, "Value", "", iCOLUMN_LARGE_WIDTH, iHEADER_HEIGHT, UIHorizontalAlignment.Left, UIAlignAnchor.TopRight, null);
                }
            }
        ...
        private List<GeneralContainer> GetGeneralStats()
        {
            ...
            if (SaveGameSettings.GetSettings().EnableNewTransferManager)
            {
                ...
                if (SaveGameSettings.GetSettings().UsePathDistanceServices || SaveGameSettings.GetSettings().UsePathDistanceGoods)
                {
                    list.Add(new GeneralContainer("Average Path Distance Match Job Time (ms)", $"{Math.Round(TransferManagerStats.GetAveragePathDistanceMatchTime(), 2)} ms"));
                }
