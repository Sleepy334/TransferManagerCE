...
namespace TransferManagerCE
{
    public class DistrictPanel : UIPanel
    {
        ...
        public void UpdatePanel()
        {
            ...
            bool bDisable = false;
            if (m_bIncoming && restrictionSettings.m_iPreferLocalDistrictsIncoming == RestrictionSettings.PreferLocal.ALL_DISTRICTS)
            {
                bDisable = true;
            }
            else if (!m_bIncoming && restrictionSettings.m_iPreferLocalDistrictsOutgoing == RestrictionSettings.PreferLocal.ALL_DISTRICTS)
            {
                bDisable = true;
            }
