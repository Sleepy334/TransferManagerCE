...
namespace SleepyCommon
{
    public class ListViewHeaderColumnIcon : ListViewHeaderColumnBase
    {
                ...
                base(eColumn, sText, eventCallback)
        {
            ...
            m_pnlIcon.height = TransferBuildingPanel.iHEADER_HEIGHT;
            m_pnlIcon.width = 100;
            ...
            m_lblIconSort.height = TransferBuildingPanel.iHEADER_HEIGHT;
            ...
            m_lblIcon.height = TransferBuildingPanel.iHEADER_HEIGHT;
            m_lblIcon.width = 30;
