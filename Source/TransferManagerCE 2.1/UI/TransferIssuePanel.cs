...
namespace TransferManagerCE
{
    public class TransferIssuePanel : UIPanel
    {
        ...
        public override void Start()
        {
            ...
            m_btnResetPathing = UIUtils.AddButton(this, Localization.Get("btnResetPathingStatistics"), 200, 30, OnReset);
            m_btnResetRoadAccess = UIUtils.AddButton(this, Localization.Get("btnResetRoadAccess"), 200, 30, OnResetRoadAccess);
