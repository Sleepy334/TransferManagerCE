...
namespace TransferManagerCE
{
	public class SettingsSlider
    {
		...
		{
			return Create((UIPanel)helper.self, direction, sText, UIFonts.SemiBold, fTextScale, iLabelWidth, iSliderWidth, fMin, fMax, fStep, fDefault, iDecimalPlaces, eventCallback);
        }

		public static SettingsSlider Create(UIPanel parent, LayoutDirection direction, string sText, float fTextScale, int iLabelWidth, int iSliderWidth, float fMin, float fMax, float fStep, float fDefault, int iDecimalPlaces, ICities.OnValueChanged eventCallback)
		{
			return Create(parent, direction, sText, UIFonts.SemiBold, fTextScale, iLabelWidth, iSliderWidth, fMin, fMax, fStep, fDefault, iDecimalPlaces, eventCallback);
        }
