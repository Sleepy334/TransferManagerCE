    ...
    public static class IndustrialBuildingAISimulationStepActive
    {
        ...
        public static void PatchGenericIndustriesHandler()
        {
                ...
                SaveGameSettings.GetSettings().OverrideGenericIndustriesHandler)
            {
                ...
                {
#if DEBUG
                    Debug.Log("Patching generic industries handler...", false);
#endif
            ...
            {
#if DEBUG
                Debug.Log("Unpatching generic industries handler...", false);
#endif
        ...
        public static IEnumerable<CodeInstruction> IndustrialBuildingSimulationStepActiveTranspiler(ILGenerator generator, IEnumerable<CodeInstruction> instructions)
        {
            ...
            if (s_bPatched)
            {
                Debug.Log($"ERROR: IndustrialBuildingAI.SimulationStepActive - Already patched!", false);
            ...
            if (bAddedBranch && bAddedLabel && bAddedOffers)
            {
                Debug.Log("IndustrialBuildingSimulationStepActiveTranspiler - Patching of IndustrialBuildingAI.SimulationStepActive succeeded", false);
            }
            else
            {
                Debug.Log($"IndustrialBuildingSimulationStepActiveTranspiler - Patching of IndustrialBuildingAI.SimulationStepActive failed. bAddedBranch: {bAddedBranch} bAddedLabel: {bAddedLabel} bAddedOffers: {bAddedOffers}", false);
            }
        }
