...
namespace TransferManagerCE
{
    ...
    {
        public static string DescribeInstance(InstanceID instance, bool bShowId = false)
        {
            if (instance.IsEmpty)
            {
                return "Empty";
                    ...
                    case InstanceType.Building:
                        {
                            ...
                            {
                                string sName = CitiesUtils.GetBuildingName(instance.Building, bShowId);
        ...
        public static void ShowInstanceSetBuildingPanel(InstanceID instance, bool bZoom = false)
        {
            ShowInstance(instance, bZoom);
            ...
            if (instance.Building != 0)
            {
                ...
                else if (BuildingPanel.Instance is not null && BuildingPanel.Instance.isVisible)
                {
                    BuildingPanel.Instance.ShowPanel(instance.Building);
                }
            }
