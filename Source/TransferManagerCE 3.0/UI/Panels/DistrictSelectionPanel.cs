...
namespace TransferManagerCE.UI
{
    public class DistrictSelectionPanel : UIPanel
    {
        ...
        public override void Start()
        {
            ...
            m_chkCurrentDistrict = UIUtils.AddCheckbox(mainPanel, Localization.Get("txtCurrentDistrict") + ": ", UIFonts.Regular, 1.0f, true, OnDistrictChanged);
            m_chkCurrentPark = UIUtils.AddCheckbox(mainPanel, Localization.Get("txtCurrentPark") + ": ", UIFonts.Regular, 1.0f, true, OnParkChanged);
