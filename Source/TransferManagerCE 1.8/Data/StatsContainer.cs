    ...
    public class StatsContainer : ListData
    {
        ...
        public override string GetText(ListViewRowComparer.Columns eColumn)
        {
            switch (eColumn)
            {
                ...
                case ListViewRowComparer.Columns.COLUMN_MATCH_OUTSIDE: return TotalOutside.ToString();
        ...
        public override void CreateColumns(ListViewRow oRow, List<ListViewRowColumn> m_columns)
        {
            ...
            oRow.AddColumn(ListViewRowComparer.Columns.COLUMN_MATCH_OUTSIDE, GetText(ListViewRowComparer.Columns.COLUMN_MATCH_OUTSIDE), "", StatsPanel.iCOLUMN_WIDTH, UIHorizontalAlignment.Center, UIAlignAnchor.TopRight);
