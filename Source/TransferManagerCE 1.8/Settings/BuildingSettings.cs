...
namespace TransferManagerCE
{
    public class BuildingSettings : IEquatable<BuildingSettings>
    {
        ...
        public List<DistrictData> m_incomingDistrictAllowed;
        public List<DistrictData> m_outgoingDistrictAllowed;
        ...
        public BuildingSettings()
        {
            ...
            m_incomingDistrictAllowed = new List<DistrictData>();

            m_bOutgoingAllowLocalDistrict = true;
            m_bOutgoingAllowLocalPark = true;
            m_outgoingDistrictAllowed = new List<DistrictData>();
        }
        ...
        public BuildingSettings(BuildingSettings oSecond)
        {
            ...
            m_incomingDistrictAllowed = new List<DistrictData>(oSecond.m_incomingDistrictAllowed);
            ...
            m_outgoingDistrictAllowed = new List<DistrictData>(oSecond.m_outgoingDistrictAllowed);
        }
        ...
        public static List<DistrictData> GetAllowedDistrictsIncoming(ushort buildingId)
        {
            ...
            list.AddRange(settings.m_incomingDistrictAllowed);
        ...
        public static List<DistrictData> GetAllowedDistrictsOutgoing(ushort buildingId)
        {
            List<DistrictData> list = new List<DistrictData>();
            ...
            list.AddRange(settings.m_outgoingDistrictAllowed);
        ...
        {
            string sMessage = Localization.Get("txtAllowedDistricts") + ":";
            if (m_iPreferLocalDistrictsIncoming == PreferLocal.ALLOW_ANY_DISTRICT)
            {
                sMessage += "\r\n- " + Localization.Get("dropdownBuildingPanelPreferLocal1");
            }
            else
            {
                List<DistrictData> list = GetAllowedDistrictsIncoming(buildingId);
        ...
        {
            string sMessage = Localization.Get("txtAllowedDistricts") + ":";
            if (m_iPreferLocalDistrictsOutgoing == PreferLocal.ALLOW_ANY_DISTRICT)
            {
                sMessage += "\r\n- " + Localization.Get("dropdownBuildingPanelPreferLocal1");
            }
            else
            {
                List<DistrictData> list = GetAllowedDistrictsOutgoing(buildingId);
                foreach (DistrictData district in list)
                {
                    if (district.m_eType == DistrictData.DistrictType.District)
                    {
        ...
        public List<DistrictData> ValidateDistricts(List<DistrictData> districts)
        {
            List<DistrictData> newSet = new List<DistrictData>();
        ...
        public bool Validate()
        {
            ...
            {
                List<DistrictData> newIncoming = ValidateDistricts(m_incomingDistrictAllowed);
                ...
                List<DistrictData> newOutgoing = ValidateDistricts(m_outgoingDistrictAllowed);
