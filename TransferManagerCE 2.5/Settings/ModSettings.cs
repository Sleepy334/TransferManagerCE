...
namespace TransferManagerCE.Settings
{
    public class ModSettings
    {
        ...
        public int ForceTrainSpawnAtCount
        {
            get;
            set;
        } = 240;

        public int ForceShipSpawnAtCount
        {
            get;
            set;
        } = 100;

        public int ForcePlaneSpawnAtCount
        {
            get;
            set;
        } = 200;

        public int ForceBusSpawnAtCount
        {
            get;
            set;
        } = 60;
        ...
        public bool ForceCargoShipDespawnOutsideConnections
        {
            get;
            set;
        } = true;

        public bool ForceCargoPlaneDespawnOutsideConnections
        {
            get;
            set;
        } = true;
