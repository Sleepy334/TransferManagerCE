...
namespace TransferManagerCE
{
    public class BuildingPanel : UIPanel
    {
        ...
        {
            ModSettings.GetSettings().HighlightMatches = !ModSettings.GetSettings().HighlightMatches;
        ...
        public void UpdateHighlightButtonIcon()
        {
            if (m_title != null && m_title.m_btnHighlight != null)
            {
                ...
                {
                    m_title.m_btnHighlight.normalBgSprite = "InfoIconLevel";
                }
                else
                {
                    m_title.m_btnHighlight.normalBgSprite = "InfoIconLevelPressed";
                }
            }
        }
            ...
            if (m_buildingId != 0)
            {
                if (m_tabStrip != null)
                {
                    ...
                    if (m_tabStrip.IsTabVisible((int)TabIndex.TAB_VEHICLES))
                    {
                        ...
                        string sMessage = Localization.Get("tabBuildingPanelVehicles") + " (" + vehicles.Count;
