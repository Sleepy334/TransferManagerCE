...
namespace TransferManagerCE.CustomManager
{
    public class PathDistanceTypes
    {
        ...
        public static void GetService(TransferReason material, CustomTransferOffer offer, out ItemClass.Service service1, out ItemClass.Service service2, out ItemClass.Service service3)
        {
            switch (material)
            {
                case TransferReason.Oil:
