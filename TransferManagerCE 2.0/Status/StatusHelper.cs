...
namespace TransferManagerCE
{
    public class StatusHelper
    {
                        ...
                        case PoliceCopterAI:
                            {
                                switch (eBuildingType)
                                {
                                    ...
                                    case BuildingType.PoliceStation:
                                        m_listIncoming.Add(new StatusDataCrime(eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                        break;
                                    default:
                                        m_listServices.Add(new StatusDataCrime(eBuildingType, buildingId, vehicle.m_sourceBuilding, actualVehicleId));
                                        break;
                                }
        ...
        {  
            ...
            if (!m_setAddedReasons.Contains(TransferReason.Sick))
            {
                switch (eBuildingType)
                {
                    case BuildingType.Hospital:
            ...
            if (!m_setAddedReasons.Contains(TransferReason.Crime))
            {
                switch (eBuildingType)
                {
                    case BuildingType.PoliceHelicopterDepot:
                    case BuildingType.PoliceStation:
                        m_listIncoming.Add(new StatusDataCrime(eBuildingType, buildingId, 0, 0));
                        break;
                    default:
                        m_listServices.Add(new StatusDataCrime(eBuildingType, buildingId, 0, 0));
                        break;
                }
                m_setAddedReasons.Add(TransferReason.Crime);
            }
