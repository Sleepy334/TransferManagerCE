    ...
    public class UITitleBar : UIPanel
    {
        ...
        private void SetupControls(string sTitle)
        {
            ...
            if (m_onFollowClick != null)
            {
                ...
                m_btnFollow.relativePosition = new Vector3(width - m_close.width - iBUTTON_MARGIN, 2);
            ...
            if (m_onStatsClick != null)
            {
                ...
                m_btnStats.width = height;
                m_btnStats.height = height;
                m_btnStats.relativePosition = new Vector3(width - m_close.width - iBUTTON_MARGIN, 2);
