...
namespace TransferManagerCE
{
    public class DistrictPanel : UIPanel
    {
        ...
        public void UpdatePanel()
        {
            ...
            bool bDisable = false;
            if (m_bIncoming && settings.m_iPreferLocalDistrictsIncoming == BuildingSettings.PreferLocal.ALLOW_ANY_DISTRICT)
            {
                bDisable = true;
            }
            else if (!m_bIncoming && settings.m_iPreferLocalDistrictsOutgoing == BuildingSettings.PreferLocal.ALLOW_ANY_DISTRICT)
            {
                bDisable = true;
            }
