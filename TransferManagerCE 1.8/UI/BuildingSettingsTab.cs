...
namespace TransferManagerCE.UI
{
    public class BuildingSettingsTab
    {
        ...
        public void Setup(UITabStrip tabStrip)
        {
            ...
            if (tabSettings != null)
            {
                ...
                if (m_grpDistrictRestrictions != null)
                {
                    ...
                    m_btnIncomingSelectDistrict = UIUtils.AddButton(m_panelIncomingDistrict, Localization.Get("btnDistrict") + "...", 120, m_dropPreferLocalIncoming.m_dropdown.height);
                    ...
                    m_btnOutgoingSelectDistrict = UIUtils.AddButton(m_panelOutgoingDistrict, Localization.Get("btnDistrict") + "...", 120, m_dropPreferLocalOutgoing.m_dropdown.height);
        ...
        {
            Debug.Log("OnSelectOutgoingDistrictClicked");
                        ...
                        if (bIncoming || bOutgoing)
                        {
                            ...
                            if (m_panelIncomingDistrict != null)
                            {
                                ...
                                if (m_btnIncomingSelectDistrict != null)
                                {
                                    ...
                                    m_btnIncomingSelectDistrict.isEnabled = (settings.m_iPreferLocalDistrictsIncoming != BuildingSettings.PreferLocal.ALLOW_ANY_DISTRICT);
                            ...
                            if (m_panelOutgoingDistrict != null)
                            {
                                ...
                                if (m_btnOutgoingSelectDistrict != null)
                                {
                                    ...
                                    m_btnOutgoingSelectDistrict.isEnabled = (settings.m_iPreferLocalDistrictsOutgoing != BuildingSettings.PreferLocal.ALLOW_ANY_DISTRICT);
                                ...
                                if (m_chkDistrictAllowServices != null)
                                {
                                    ...
                                    m_chkDistrictAllowServices.isEnabled = (settings.m_iPreferLocalDistrictsOutgoing != BuildingSettings.PreferLocal.ALLOW_ANY_DISTRICT);
                                }
                            }
