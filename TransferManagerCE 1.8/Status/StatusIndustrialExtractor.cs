...
{
    public class StatusIndustrialExtractor : StatusData
    {
        public StatusIndustrialExtractor(TransferReason reason, BuildingType eBuildingType, ushort BuildingId, ushort responder, ushort target) :
